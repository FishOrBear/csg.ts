 ...
 */
export function translate(vector, ...objects)
{
    // v, obj or array
 ...
 */
export function scale(scale, ...objects)
{
    // v, obj or array
    const _objects =
        objects.length >= 1 && objects[0].length ? objects[0] : objects;
 ...
 */
export function center(axes, ...objects)
{
    const _objects =
        objects.length >= 1 && objects[0].length ? objects[0] : objects;
    let object = _objects[0];
 ...
 */
export function mirror(vector, ...objects)
{
    const _objects =
        objects.length >= 1 && objects[0].length ? objects[0] : objects;
    let object = _objects[0];
    ...
    const plane = new Plane(
        new Vector3D(vector[0], vector[1], vector[2]).unit(),
        0
    );
 ...
 */
export function expand(radius, n, object)
{
 ...
 */
export function contract(radius, n, object)
{
 ...
 */
export function chain_hull(params, objects)
{
    /*
    const defaults = {
      closed: false
