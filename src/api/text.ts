 ...
 */
export function vectorChar(options, char)
{
    ...
    {
        let gx = ratio * glyph[i] + xOffset;
        let gy = ratio * glyph[i + 1] + yOffset + extrudeYOffset;
 ...
 */
export function vectorText(options, text)
{
    let {
        xOffset,
        yOffset,
...
*/
export function vector_char(x, y, char)
{
 ...
 */
export function vector_text(x, y, text)
{
